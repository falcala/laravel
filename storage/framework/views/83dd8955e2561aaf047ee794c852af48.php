<?php $items = $section->content['items'] ?? []; $secId = $section->id; ?>
...
<div id="feature-items-<?php echo e($secId); ?>">
  ...
  <?php $iconVal = $item['icon'] ?? 'bx-star'; ?>
  <div class="border rounded p-3 mb-2 feature-item">
    <div class="d-flex justify-content-between mb-2">
      <strong class="small">Feature <?php echo e($i + 1); ?></strong>
      ...
      <div class="col-12">
        ...
        <div class="d-flex align-items-center gap-2">
          ...
          <div class="icon-preview d-flex align-items-center justify-content-center border rounded"
            ...
            <i class="bx <?php echo e($iconVal); ?>" style="font-size:1.3rem;color:#696cff"></i>
          </div>
          
          <input type="text"
                 name="content[items][<?php echo e($i); ?>][icon]"
                 class="form-control form-control-sm icon-input"
                 value="<?php echo e($iconVal); ?>"
                 placeholder="bx-star">
...
<button type="button" class="btn btn-outline-primary btn-sm w-100 mt-1 add-feature-btn"
        data-section="<?php echo e($secId); ?>">
  <i class="bx bx-plus me-1"></i> Add Feature
</button>


<div class="modal fade" id="iconPickerModal-<?php echo e($secId); ?>" tabindex="-1" aria-hidden="true">
...
<?php /**PATH C:\xampp\htdocs\sneat\resources\views/content/pages/sections/features.blade.php ENDPATH**/ ?>